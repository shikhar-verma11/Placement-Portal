...
export const TECH_STACK: TechItem[] = [
  ...
  },
  {
    ...
    role: 'Student / Company / Admin roles.',
    icon: 'Layers',
    glowColor: '#092E20',
    description: 'Provides enterprise-grade security, CSRF protection, and structured backend API routing.',
    speed: 'Role-Based Authentication'
  },
  {
    id: 'tech-celery',
    name: 'Celery & Redis',
    category: 'Task Queue',
    role: 'Email & notification dispatch.',
    icon: 'Cpu',
    glowColor: '#37B24D',
    description: 'Executes thousands of parallel notifications, PDF builds, and mail dispatches asynchronously.',
  ...
  },
  {
    ...
    role: 'Analytics & placement reports.',
    icon: 'Binary',
    glowColor: '#130654',
    description: 'Processes academic records, filters batches, and aggregates performance stats.',
    speed: 'Vectorized Filtering'
  },
  {
    id: 'tech-openpyxl',
    name: 'OpenPyXL',
    category: 'Report Engine',
    role: 'Excel export for admin use.',
  ...
  },
  {
    ...
    role: 'Clean UI & responsive grid layout.',
    icon: 'Layout',
    glowColor: '#7952B3',
  ...
  },
  {
    ...
    role: 'Clean UI & server-side HTML rendering engine.',
    icon: 'Layers',
    glowColor: '#092E20',
  ...
  },
  {
    ...
    role: 'Smart resume skill parsing & career recommendations.',
    icon: 'Sparkles',
    glowColor: '#00FFC6',
  ...
  },
  {
    ...
    name: 'PostgreSQL',
    category: 'Database',
    role: 'ACID compliant relational storage.',
    icon: 'Database',
    glowColor: '#336791',
